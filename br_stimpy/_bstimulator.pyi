...
class CallbackType:
    ...
    ]  # value = {'callback_all': <CallbackType.callback_all: 0>, 'callback_device_attachment': <CallbackType.callback_device_attachment: 1>, 'callback_count': <CallbackType.callback_count: 2>}
    callback_all: typing.ClassVar[
        CallbackType
    ]  # value = <CallbackType.callback_all: 0>
    callback_count: typing.ClassVar[
        CallbackType
    ]  # value = <CallbackType.callback_count: 2>
    callback_device_attachment: typing.ClassVar[
        CallbackType
    ]  # value = <CallbackType.callback_device_attachment: 1>
...
class EventType:
    ...
    __members__: typing.ClassVar[
        dict[str, EventType]
    ]  # value = {'event_device_attached': <EventType.event_device_attached: 0>, 'event_device_detached': <EventType.event_device_detached: 1>, 'event_count': <EventType.event_count: 2>}
    event_count: typing.ClassVar[EventType]  # value = <EventType.event_count: 2>
    event_device_attached: typing.ClassVar[
        EventType
    ]  # value = <EventType.event_device_attached: 0>
    event_device_detached: typing.ClassVar[
        EventType
    ]  # value = <EventType.event_device_detached: 1>
    def __eq__(self, other: typing.Any) -> bool: ...
    def __getstate__(self) -> int: ...
    def __hash__(self) -> int: ...
    def __index__(self) -> int: ...
...
class InterfaceType:
    ...
    ]  # value = {'interface_default': <InterfaceType.interface_default: 0>, 'interface_cpusb': <InterfaceType.interface_cpusb: 1>, 'interface_count': <InterfaceType.interface_count: 2>}
    interface_count: typing.ClassVar[
        InterfaceType
    ]  # value = <InterfaceType.interface_count: 2>
    interface_cpusb: typing.ClassVar[
        InterfaceType
    ]  # value = <InterfaceType.interface_cpusb: 1>
    interface_default: typing.ClassVar[
        InterfaceType
    ]  # value = <InterfaceType.interface_default: 0>
    def __eq__(self, other: typing.Any) -> bool: ...
    def __getstate__(self) -> int: ...
    def __hash__(self) -> int: ...
    def __index__(self) -> int: ...
...
class ModuleStatus:
    ...
    ]  # value = {'module_unavailable': <ModuleStatus.module_unavailable: 0>, 'module_enabled': <ModuleStatus.module_enabled: 1>, 'module_disabled': <ModuleStatus.module_disabled: 2>, 'module_ok': <ModuleStatus.module_ok: 3>, 'module_voltagelimitation': <ModuleStatus.module_voltagelimitation: 4>, 'module_count': <ModuleStatus.module_count: 5>}
    module_count: typing.ClassVar[
        ModuleStatus
    ]  # value = <ModuleStatus.module_count: 5>
    module_disabled: typing.ClassVar[
        ModuleStatus
    ]  # value = <ModuleStatus.module_disabled: 2>
    module_enabled: typing.ClassVar[
        ModuleStatus
    ]  # value = <ModuleStatus.module_enabled: 1>
    module_ok: typing.ClassVar[ModuleStatus]  # value = <ModuleStatus.module_ok: 3>
    module_unavailable: typing.ClassVar[
        ModuleStatus
    ]  # value = <ModuleStatus.module_unavailable: 0>
    module_voltagelimitation: typing.ClassVar[
        ModuleStatus
    ]  # value = <ModuleStatus.module_voltagelimitation: 4>
    def __eq__(self, other: typing.Any) -> bool: ...
    def __getstate__(self) -> int: ...
    def __hash__(self) -> int: ...
    def __index__(self) -> int: ...
...
class PartNumbers:
    ...
    __members__: typing.ClassVar[
        dict[str, PartNumbers]
    ]  # value = {'PN6425': <PartNumbers.PN6425: 0>, 'PN7008': <PartNumbers.PN7008: 1>, 'PN7039': <PartNumbers.PN7039: 2>, 'PN7169': <PartNumbers.PN7169: 3>, 'PN8543': <PartNumbers.PN8543: 4>, 'PN7655': <PartNumbers.PN7655: 5>, 'PN7656': <PartNumbers.PN7656: 6>, 'PN7875': <PartNumbers.PN7875: 7>, 'PN8544': <PartNumbers.PN8544: 8>, 'PN_invalid': <PartNumbers.PN_invalid: 15>}
    def __eq__(self, other: typing.Any) -> bool: ...
    def __getstate__(self) -> int: ...
    def __hash__(self) -> int: ...
    def __index__(self) -> int: ...
...
class ResultType:
    ...
    amp_great_max: typing.ClassVar[
        ResultType
    ]  # value = <ResultType.amp_great_max: -124>
    callback_reg_failed: typing.ClassVar[
        ResultType
    ]  # value = <ResultType.callback_reg_failed: -21>
    channel_used_in_group: typing.ClassVar[
        ResultType
    ]  # value = <ResultType.channel_used_in_group: -119>
    config_not_active: typing.ClassVar[
        ResultType
    ]  # value = <ResultType.config_not_active: -120>
    connected: typing.ClassVar[ResultType]  # value = <ResultType.connected: -10>
    device_locked: typing.ClassVar[
        ResultType
    ]  # value = <ResultType.device_locked: -131>
    device_notify: typing.ClassVar[
        ResultType
    ]  # value = <ResultType.device_notify: -13>
    device_registered: typing.ClassVar[
        ResultType
    ]  # value = <ResultType.device_registered: -7>
    ...
    freq_period_zero: typing.ClassVar[
        ResultType
    ]  # value = <ResultType.freq_period_zero: -23>
    frequency_great_max: typing.ClassVar[
        ResultType
    ]  # value = <ResultType.frequency_great_max: -130>
    interface_read: typing.ClassVar[
        ResultType
    ]  # value = <ResultType.interface_read: -16>
    interface_timeout: typing.ClassVar[
        ResultType
    ]  # value = <ResultType.interface_timeout: -6>
    interface_write: typing.ClassVar[
        ResultType
    ]  # value = <ResultType.interface_write: -15>
    invalid_afcf: typing.ClassVar[ResultType]  # value = <ResultType.invalid_afcf: -110>
    invalid_amplitude: typing.ClassVar[
        ResultType
    ]  # value = <ResultType.invalid_amplitude: -109>
    invalid_callback_type: typing.ClassVar[
        ResultType
    ]  # value = <ResultType.invalid_callback_type: -20>
    invalid_channel: typing.ClassVar[
        ResultType
    ]  # value = <ResultType.invalid_channel: -104>
    invalid_command: typing.ClassVar[
        ResultType
    ]  # value = <ResultType.invalid_command: -14>
    invalid_config: typing.ClassVar[
        ResultType
    ]  # value = <ResultType.invalid_config: -105>
    invalid_fastdisch: typing.ClassVar[
        ResultType
    ]  # value = <ResultType.invalid_fastdisch: -115>
    invalid_frequency: typing.ClassVar[
        ResultType
    ]  # value = <ResultType.invalid_frequency: -129>
    invalid_handle: typing.ClassVar[
        ResultType
    ]  # value = <ResultType.invalid_handle: -3>
    invalid_interface: typing.ClassVar[
        ResultType
    ]  # value = <ResultType.invalid_interface: -5>
    invalid_interphase: typing.ClassVar[
        ResultType
    ]  # value = <ResultType.invalid_interphase: -114>
    invalid_interpulse: typing.ClassVar[
        ResultType
    ]  # value = <ResultType.invalid_interpulse: -113>
    invalid_module: typing.ClassVar[
        ResultType
    ]  # value = <ResultType.invalid_module: -116>
    invalid_module_enum: typing.ClassVar[
        ResultType
    ]  # value = <ResultType.invalid_module_enum: -19>
    invalid_number: typing.ClassVar[
        ResultType
    ]  # value = <ResultType.invalid_number: -106>
    invalid_params: typing.ClassVar[
        ResultType
    ]  # value = <ResultType.invalid_params: -8>
    invalid_pulses: typing.ClassVar[
        ResultType
    ]  # value = <ResultType.invalid_pulses: -111>
    invalid_rwr: typing.ClassVar[ResultType]  # value = <ResultType.invalid_rwr: -107>
    invalid_trigger: typing.ClassVar[
        ResultType
    ]  # value = <ResultType.invalid_trigger: -103>
    invalid_voltage: typing.ClassVar[
        ResultType
    ]  # value = <ResultType.invalid_voltage: -108>
    invalid_width: typing.ClassVar[
        ResultType
    ]  # value = <ResultType.invalid_width: -112>
    library_firmware: typing.ClassVar[
        ResultType
    ]  # value = <ResultType.library_firmware: -22>
    module_disabled: typing.ClassVar[
        ResultType
    ]  # value = <ResultType.module_disabled: -127>
    module_enabled: typing.ClassVar[
        ResultType
    ]  # value = <ResultType.module_enabled: -128>
    module_unavailable: typing.ClassVar[
        ResultType
    ]  # value = <ResultType.module_unavailable: -118>
    no_device_selected: typing.ClassVar[
        ResultType
    ]  # value = <ResultType.no_device_selected: -24>
    nok: typing.ClassVar[ResultType]  # value = <ResultType.nok: -100>
    not_implemented: typing.ClassVar[
        ResultType
    ]  # value = <ResultType.not_implemented: -1>
    null_ptr: typing.ClassVar[ResultType]  # value = <ResultType.null_ptr: -4>
    phase_great_max: typing.ClassVar[
        ResultType
    ]  # value = <ResultType.phase_great_max: -123>
    phase_not_balanced: typing.ClassVar[
        ResultType
    ]  # value = <ResultType.phase_not_balanced: -122>
    ...
    sequence_error: typing.ClassVar[
        ResultType
    ]  # value = <ResultType.sequence_error: -102>
    stim_attached: typing.ClassVar[
        ResultType
    ]  # value = <ResultType.stim_attached: -11>
    stim_detached: typing.ClassVar[
        ResultType
    ]  # value = <ResultType.stim_detached: -12>
    stimuli_modules: typing.ClassVar[
        ResultType
    ]  # value = <ResultType.stimuli_modules: -117>
    ...
    volt_great_max: typing.ClassVar[
        ResultType
    ]  # value = <ResultType.volt_great_max: -126>
    width_great_max: typing.ClassVar[
        ResultType
    ]  # value = <ResultType.width_great_max: -125>
...
class SeqType:
    ...
    __members__: typing.ClassVar[
        dict[str, SeqType]
    ]  # value = {'stop': <SeqType.stop: 0>, 'pause': <SeqType.pause: 1>, 'playing': <SeqType.playing: 2>, 'writing': <SeqType.writing: 3>, 'trigger': <SeqType.trigger: 4>, 'invalid': <SeqType.invalid: 5>}
...
class Stimulator:
    ...
    def auto_stimulus(
        self, electrode: typing.SupportsInt | typing.SupportsIndex, configID: Config
    ) -> ResultType:
        """
    ...
    def configure_stimulus_pattern(
        ...
        configID: Config,
        afcf: WFType,
        pulses: typing.SupportsInt | typing.SupportsIndex,
        amp1: typing.SupportsInt | typing.SupportsIndex,
        amp2: typing.SupportsInt | typing.SupportsIndex,
        width1: typing.SupportsInt | typing.SupportsIndex,
        width2: typing.SupportsInt | typing.SupportsIndex,
        frequency: typing.SupportsInt | typing.SupportsIndex,
        interphase: typing.SupportsInt | typing.SupportsIndex,
    ) -> ResultType:
        """
    ...
    def connect(
        self, stim_interface: InterfaceType, params: typing_extensions.CapsuleType
    ) -> ResultType:
        """
    ...
    def disable_module(
        self, module: typing.SupportsInt | typing.SupportsIndex
    ) -> ResultType:
        """
    ...
    def disable_stimulus_configuration(
        self, config_id: typing.SupportsInt | typing.SupportsIndex
    ) -> ResultType:
        """
    ...
    def get_module_firmware_version(
        self,
    ) -> typing.Annotated[list[int], "FixedSize(16)"]:
        """
    ...
    def group_stimulus(
        self,
        begin_seq: typing.SupportsInt | typing.SupportsIndex,
        play: typing.SupportsInt | typing.SupportsIndex,
        times: typing.SupportsInt | typing.SupportsIndex,
        number: typing.SupportsInt | typing.SupportsIndex,
        input: GroupStimulus,
    ) -> ResultType:
        """
    ...
    def max_output_voltage(
        self,
        output: MaxOutputVoltage,
        rw: typing.SupportsInt | typing.SupportsIndex,
        voltage: OCVolt,
    ) -> ResultType:
        """
    ...
    def measure_output_voltage(
        ...
        module: typing.SupportsInt | typing.SupportsIndex,
        electrode: typing.SupportsInt | typing.SupportsIndex,
    ) -> ResultType:
        """
    ...
    def read_stimulus_pattern(
        self, output: StimulusConfiguration, configID: Config
    ) -> ResultType:
        """
    ...
    def set_device(
        self, device_index: typing.SupportsInt | typing.SupportsIndex
    ) -> ResultType:
        """
        Using the index of the device in the serial number list obtained from scanForDevices(), set the device you want to connect.
        """

    def stimulus_max_values(
        self,
        output: MaximumValues,
        rw: typing.SupportsInt | typing.SupportsIndex,
        voltage: OCVolt,
        amplitude: typing.SupportsInt | typing.SupportsIndex,
        phase_charge: typing.SupportsInt | typing.SupportsIndex,
        frequency: typing.SupportsInt | typing.SupportsIndex,
    ) -> ResultType:
        """
    ...
    def wait(
        self, milliseconds: typing.SupportsInt | typing.SupportsIndex
    ) -> ResultType:
        """
    ...
    def write_eeprom(
        self,
        addr: typing.SupportsInt | typing.SupportsIndex,
...
class StimulatorType:
    ...
    __members__: typing.ClassVar[
        dict[str, StimulatorType]
    ]  # value = {'micro_stim': <StimulatorType.micro_stim: 0>, 'macro_stim': <StimulatorType.macro_stim: 1>, 'invalid_stim': <StimulatorType.invalid_stim: 2>}
    invalid_stim: typing.ClassVar[
        StimulatorType
    ]  # value = <StimulatorType.invalid_stim: 2>
    macro_stim: typing.ClassVar[
        StimulatorType
    ]  # value = <StimulatorType.macro_stim: 1>
    micro_stim: typing.ClassVar[
        StimulatorType
    ]  # value = <StimulatorType.micro_stim: 0>
    def __eq__(self, other: typing.Any) -> bool: ...
    def __getstate__(self) -> int: ...
    def __hash__(self) -> int: ...
    def __index__(self) -> int: ...
...
class TestModules:
    ...
    def modules_mv(
        ...
        list[typing.Annotated[list[int], "FixedSize(5)"]], "FixedSize(16)"
    ]:
        """
...
class TriggerType:
    ...
    __members__: typing.ClassVar[
        dict[str, TriggerType]
    ]  # value = {'trigger_disabled': <TriggerType.trigger_disabled: 0>, 'trigger_rising': <TriggerType.trigger_rising: 1>, 'trigger_falling': <TriggerType.trigger_falling: 2>, 'trigger_change': <TriggerType.trigger_change: 3>, 'trigger_invalid': <TriggerType.trigger_invalid: 4>}
    trigger_change: typing.ClassVar[
        TriggerType
    ]  # value = <TriggerType.trigger_change: 3>
    trigger_disabled: typing.ClassVar[
        TriggerType
    ]  # value = <TriggerType.trigger_disabled: 0>
    trigger_falling: typing.ClassVar[
        TriggerType
    ]  # value = <TriggerType.trigger_falling: 2>
    trigger_invalid: typing.ClassVar[
        TriggerType
    ]  # value = <TriggerType.trigger_invalid: 4>
    trigger_rising: typing.ClassVar[
        TriggerType
    ]  # value = <TriggerType.trigger_rising: 1>
    def __eq__(self, other: typing.Any) -> bool: ...
    def __getstate__(self) -> int: ...
    def __hash__(self) -> int: ...
    def __index__(self) -> int: ...
...
class WFType:
    ...
    __members__: typing.ClassVar[
        dict[str, WFType]
    ]  # value = {'wf_anodic_first': <WFType.wf_anodic_first: 0>, 'wf_cathodic_first': <WFType.wf_cathodic_first: 1>, 'wf_invalid': <WFType.wf_invalid: 2>}
...
callback_device_attachment: (
    CallbackType  # value = <CallbackType.callback_device_attachment: 1>
)
...
module_voltagelimitation: (
    ModuleStatus  # value = <ModuleStatus.module_voltagelimitation: 4>
)
